...
class PipelineTests(unittest.TestCase):
    ...
    def test_home_uses_category_and_people_sections(self) -> None:
        ...
        self.assertIn('<span class="status-count">', output)
        self.assertIn("<strong>1</strong>", output)
        self.assertIn("<span>Estimate</span>", output)
        self.assertIn("data-people-section", output)
        self.assertIn("<dt>People matches</dt>", output)
        self.assertIn('<dd class="people-count">1</dd>', output)
