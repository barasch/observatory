...
13. **Tufte-influenced, not a Tufte CSS clone.** The design uses the warm paper field, serif typography, narrow reading measure, whitespace, and no more than three structural horizontal rules on the primary page, but original CSS and system fonts.
